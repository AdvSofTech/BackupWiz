...
namespace FileBrowser
{
    ...
    // This delegate used for AfterChecked
    public delegate void AfterCheckEventHandler(object sender, SelectedFolderChangedEventArgs e);
    //public delegate void AfterCheckEventHandler2(object sender, SelectedFolderChangedEventArgs e);
    ...
    public partial class Browser : UserControl
    {
        ...
        private SpecialFolders startupDir = SpecialFolders.MyDocuments;
        ...
        /// <summary>
        /// This event will be raised when the after check event occurs
        /// </summary>
        public event AfterCheckEventHandler AfterCheck;
        //public event AfterCheckEventHandler2 AfterCheck2;
        ...
        private void InitFolderView()
        {
            ...
            //folderView.AfterCheck+= new TreeViewEventHandler(folderView_AfterCheck);
        ...
        [Category("Options"),
         ...
         DefaultValue(SpecialFolders.ControlPanel),
         Browsable(true)]
        ...
        private void folderView_AfterCheck(object sender, TreeViewEventArgs  e)
        {
            //folderView_AfterSelect(sender, e);
            //OnAfterCheck(new AfterCheckEventHandler(FolderView.))
            //FolderView.SelectedNode = e.Node;
            //OnSelectedFolderChanged(new SelectedFolderChangedEventArgs(folderView.SelectedNode));
            AfterCheck.Invoke(sender, new SelectedFolderChangedEventArgs(e.Node));
        }
    }
